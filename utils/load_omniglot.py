...
def _load_character_data(char_path):
    ...
    Args:
        char_path (str or Path): Path to character directory
        
    Returns:
        tuple: (character_tensor, char_path) or None if no images found
    """
    char_path = Path(char_path)  # Convert to Path object
